# cri-tools for LoongArch64

<p align="center"><a href="README.md">English</a> | <a href="README-zh.md">中文</a></p>

<p align="center"><img src="https://img.shields.io/badge/cri--tools%20LoongArch64%20%E9%BE%99%E8%8A%AF%E6%9E%B6%E6%9E%84%E5%8F%91%E8%A1%8C%E7%89%88-blue?logo=kubernetes&logoColor=white" alt="cri-tools LoongArch64 龙芯架构发行版"></p>

Build [cri-tools](https://github.com/kubernetes-sigs/cri-tools) binaries for the **LoongArch64 (loong64)**
architecture via CI/CD.

## How it works

A GitHub Actions workflow clones the specified cri-tools version, cross-compiles with
`GOOS=linux GOARCH=loong64`, and uploads the built binaries as workflow artifacts. Target platform: `linux/loong64`.

## Branch naming

Push a branch named `loong64-<cri-tools-version>` (e.g. `loong64-v1.36.0`) to trigger a build. Append `+<build>`
(e.g. `loong64-v1.36.0+0`) to include build metadata.

## [Release](https://github.com/kubernetes-loong64/cri-tools-loong64/releases)

Push a tag matching `release-loong64-<cri-tools-version>` (e.g. `release-loong64-v1.36.0+0`) to publish
...
| `critest` | CRI conformance test suite |
